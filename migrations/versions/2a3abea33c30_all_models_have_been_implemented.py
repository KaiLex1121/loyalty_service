...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["company_id"],
            ["companies.id"],
            name=op.f("fk__cashback_configs__company_id__companies"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk__cashback_configs")),
        sa.UniqueConstraint(
            "company_id", name=op.f("uq__cashback_configs__company_id")
        ),
    )
    op.create_table(
        "customers",
        ...
        sa.ForeignKeyConstraint(
            ["company_id"],
            ["companies.id"],
            name=op.f("fk__customers__company_id__companies"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk__customers")),
    )
    op.create_index(
        op.f("ix__customers_phone_number"), "customers", ["phone_number"], unique=True
    )
    op.create_table(
        "employees",
    ...
    op.create_index(
        op.f("ix__employees_phone_number"), "employees", ["phone_number"], unique=True
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by_user_id"],
            ["users.id"],
            name=op.f("fk__notification_messages__created_by_user_id__users"),
            ondelete="SET NULL",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["employee_id"],
            ["employees.id"],
            name=op.f("fk__employee_outlet_association__employee_id__employees"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["outlet_id"],
            ["outlets.id"],
            name=op.f("fk__employee_outlet_association__outlet_id__outlets"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint(
            "employee_id", "outlet_id", name=op.f("pk__employee_outlet_association")
        ),
    )
    op.create_table(
        "transactions",
        ...
        sa.ForeignKeyConstraint(
            ["customer_id"],
            ["customers.id"],
            name=op.f("fk__transactions__customer_id__customers"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["outlet_id"],
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name="fk__business_partner_profiles__user_id__users",
        ),
