...
from app.bots.employee_bot.states.general import MainDialogStates
...
router.message.filter(EmployeeAuthFilter())
router.callback_query.filter(EmployeeAuthFilter())
