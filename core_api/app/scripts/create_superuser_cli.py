...
from app.dao.account import AccountDAO  # Используем экземпляры DAO
from app.dao.user_role import UserRoleDAO  # Используем экземпляры DAO

# Импорты из вашего проекта
from app.db.session import create_pool
from app.enums import (  # Прямой импорт или из backend.enums
    UserAccessLevelEnum,
)
