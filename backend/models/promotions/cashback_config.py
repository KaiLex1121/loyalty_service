...
from backend.db.base import Base  # Убедитесь, что путь правильный
from backend.enums import CashbackTypeEnum

if TYPE_CHECKING:
    from backend.models.promotions.promotion import Promotion  # Импорт для type hinting
